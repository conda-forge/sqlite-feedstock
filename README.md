...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/sqlite-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sqlite-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libsqlite sqlite
# for installing globally
pixi global install libsqlite sqlite
```
...
It is possible to list all of the versions of `libsqlite` available on your platform:
...
```
pixi search libsqlite --channel conda-forge
```
